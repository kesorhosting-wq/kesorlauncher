![ar_logo](https://github.com/KesorHosting/KesorLauncher/assets/77334306/43d4acb0-546c-4dff-834d-83fb2ba6ad6f)

# AR • Theseus core Empowering Your Minecraft Adventure with Kesor Launcher • Fork of Modrinth
...
# AR • About software 🌌
Introducing Kesor Launcher, a specialized variant of Theseus dedicated to implementing offline authorization for an even more flexible and user-centric Minecraft Modrinth experience. Roam the Minecraft realms without the constraints of online authentication, thanks to Kesor Launcher.
...
Dive into the extraordinary world of Kesor Launcher, a fork of the original project with a unique focus on providing a free trial experience for Minecraft, all without the need for a license. Currently boasting:

# Install instructions
- To install our application, you need to download a file for your operating system from our available releases or development builds • [Download variants here](https://github.com/KesorHosting/KesorLauncher/releases)
...
- Forced disabling of statistics collection (modrinch metrics) with a hard patch from Kesor Launcher, ensuring it remains deactivated regardless of the configuration setting.
...
- And more...
## Getting Started
To begin your Kesor Launcher adventure, follow these steps:
1. **Download your OS version in releases** • [Download variants here](https://github.com/KesorHosting/KesorLauncher/releases)

2. **Select Your Language:** Choose between available languages in settings by configuring your language preferences.

3. **Authentication:** Enjoy the freedom to log in using a valid license or, for testing purposes, explore Kesor Launcher with a pirate account.

4. **Launch Minecraft:** Fire up Minecraft through Kesor Launcher and explore the vast landscapes and adventures that await you.
# Disclaimer
**Notice:** 
- Kesor Launcher is a project intended for experimentation and educational purposes only. It does not endorse or support piracy, and users are encouraged to obtain valid licenses for a fully-supported Minecraft experience.
